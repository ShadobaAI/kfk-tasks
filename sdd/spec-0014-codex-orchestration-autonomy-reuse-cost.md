...
Репозиторная реализация завершена. Коммит `kafka-tools`:
`ae4cb20af47c22820d12a56bfbbadf4b492461be`. Спецификация и результат реализации
зафиксированы в `kfk-tasks` коммитом `1cdf5be2fa7b33b6efd70f39262acd423fb1ddf0`.
Развёртывание и live-приёмка не выполнялись; по указанию
