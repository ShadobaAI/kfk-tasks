...
related:
  - ../sdd/spec-0001-memory-bank-foundation.md
  - adr-0002-repository-documentation-and-agents.md
---
...
- `repo:kfk-tasks:sdd/spec-0001-memory-bank-foundation.md`
- Historical MCP implementation retired by SPEC-0007.

## Related Documents

- [Foundation specification](../sdd/spec-0001-memory-bank-foundation.md)
- [Superseding decision](adr-0002-repository-documentation-and-agents.md)
